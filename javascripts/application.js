...
(function() {
  var duration, homeLinks, initializePosition, returnHome, scale, sizeHome, xImage, xLast, yImage, yLast, _positionStageOn, _setStageOriginTo;
  ...
  homeLinks = function() {
    return $("body").on("click", "#home ul a", function(e) {
      ...
      return $("#fixed-return-to-home").fadeIn(duration);
    });
  };
