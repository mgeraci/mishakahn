...
(function() {
  var clickNavigation, copyHomeMenu, hovercards, noCSS3Navigation, pan, resizeFunction, setSizeAndResize;
  ...
  $(function() {
    ...
    if ($("html").hasClass("csstransforms") && $("html").hasClass("csstransitions")) {
      ...
      return pan.initialize();
    } else {
      return noCSS3Navigation.initialize();
    }
  });
  ...
  noCSS3Navigation = {
    ...
    moveToElement: function(target) {
      var goingHome, menu, stageLeft, stageTop, targetHeight, targetPosition, targetWidth, viewportHeight, viewportWidth;
